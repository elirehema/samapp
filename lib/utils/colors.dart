...
Color textPrimaryColor = new Color.fromRGBO(4,4,4, 1.0);
Color scaffoldBackgroundColor = new Color.fromRGBO(244,244,244,1);
...
Color gray3 = new Color.fromRGBO(99, 112, 118, 1);
  ...
  /** Light theme colors **/
 Color md_theme_light_primary =  HexColor("#ED1E65");
