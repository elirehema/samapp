...
import 'package:samapp/model/serializers.dart';
...
class  BuiltValueConverter extends JsonConverter{
    ...
    return super.convertRequest(
      request.copyWith(
        ...
        body: standardSerializers.serializeWith(
          ...
          standardSerializers.serializerForType(request.body.runtimeType)!,
          request.body,
        ),
      ),
    );
  ...
  SingleItemType? _deserialize<SingleItemType>(Map<String, dynamic> value) {
    ...
    return standardSerializers.deserializeWith<dynamic>(standardSerializers.serializerForType(SingleItemType)!, value);
  }
}