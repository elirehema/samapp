...
class TabStoreOwner extends StatelessWidget{
        ...
        child:  Column(
            ...
            children: [
              Padding(padding: EdgeInsets.only(top: 20.0, bottom: 25.0, left: 5.0),
                child: Text('Owners Name', style: _theme.textTheme.labelMedium,),),
              TextFormField(
              ...
              Padding(padding: EdgeInsets.only(top: 20.0, bottom: 25.0, left: 5.0),
                child: Text('Email (Optional)', style: _theme.textTheme.labelMedium,),),
              TextFormField(
                controller: controller,
                cursorColor: _theme.primaryColor,
                style: _theme.textTheme.bodyText1,
              ...
              ElevatedButton(
                onPressed: (){
                 Navigator.of(context).push(MaterialPageRoute<void>(
                      builder: (BuildContext context) => ScreenStockAnalytics(),
                    ),
                  );
                },
                child: Text('verified'),
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all(_theme.primaryColorLight)
              ),)
